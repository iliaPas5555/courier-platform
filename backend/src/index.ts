...
import { hoursEntriesRouter } from "./routes/hoursEntries";
import { latenessRouter } from "./routes/lateness";
...
app.use("/api/hours-entries", hoursEntriesRouter);
app.use("/api/lateness", latenessRouter);
